...
export const Sidebar = ({ isListening, toggleListening }) => {
  ...
  return (
    <aside className="w-20 lg:w-64 h-screen sticky top-0 bg-white dark:bg-slate-900 flex-shrink-0 p-3 lg:p-5 flex flex-col items-center lg:items-stretch shadow-xl dark:shadow-none transition-all duration-300 overflow-y-auto z-20">
      <h1 className="text-xl font-bold text-indigo-600 dark:text-indigo-400 mb-2 lg:mb-3 hidden lg:block shrink-0">
        Trợ lý Chi tiêu
      </h1>
      ...
      <nav className="flex flex-col space-y-1.5 w-full flex-1">
        ...
        <button
          ...
          className={`flex items-center justify-center lg:justify-start text-sm font-semibold py-2.5 px-3 rounded-xl transition-all duration-200 transform hover:scale-[1.02] ${
            isListening
              ? "bg-red-600 text-white shadow-md shadow-red-200 dark:shadow-red-500/50 animate-pulse"
              : "text-slate-600 dark:text-slate-300 hover:bg-indigo-50 dark:hover:bg-slate-800"
          }`}
